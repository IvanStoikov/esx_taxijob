...
Config.NPCJobEarnings             = {min = 400, max = 500}
...
--  ADD ITEMS
Config.AddItemsPerctent = 1        --  This is percent the script will add items as well as cash from mugging.
...
Config.giveableItems = {
	...
	--[[	
	'bandage',  	-- превръзка
	'bobbypin',  	-- фуркет - за сваляне на белезници
	'book', 		-- отварачка ;)
--	'bread',		-- хляб
	'cannabis',		-- Канабис
--	'chocolate',	-- шоколад
...
--	'cigarett',		-- цигара
	'clip', 		-- Пълнител
	'coca_leaf',	-- Листа на кока
	'coke',			-- Кокаин
	'coke_pooch', 	-- Вързопче кока
	'coupon',		-- Камера
	'diamond',		-- Диамант
--	'donut',		-- Донът
--	'drpepper',		-- Кока Кола
--	'energy',		-- енергийна напитка
	'fixkit', 		-- Ремонтен комплект
	'repairkit', 	-- Ремонтен комплект ПЛЮС
	'hat',			-- Пръстен
	'heroin',		-- Хероин
	'highradio', 	-- Авто части
	'hydrochloric_acid', -- Солна киселина
--	'juice',		-- сокче
	'laptop',		-- Диктофон
	'leather', 		-- Кожи
	'lockpick',		-- за обири на къщи
	'lom',			-- кредитни карти
	'lotteryticket',-- лотариен билет
	'lowradio',		-- Кабелен сноп
	'lsa',			-- LSA
	'lsd',			-- LSD
	'meth',			-- Метамфетамини
	'meth_pooch', 	-- Кутия с метамфетамини
	'marijuana',	-- Marry Jane
	'opium', 		-- Опиум
	'opium_pooch',	-- Кашонче с опиум
	'pants', 		-- Джобен часовник
	'picklock',		-- Шперц
	'picnic',		-- Комплект за пикник
	'plastic',		-- Заготовка за кредитна карта
	'poppyresin',	-- Маков латекс
	'redgull',		-- Тауринова напитка
--	'rose',			-- роза
	'saffron',		-- Шафран
--	'sandwich',		-- Сандвич
	'seed_weed',  	-- семе на канабис Рудералис
	'speaker',		-- Старинни книги
	'shoes',		-- флашка
	'tequila', 		-- Текила
	'thionyl_chloride',  -- Тионилхлорид
	'tomato',		-- Домат
--	'umbrella',  	-- Чадър
--	'water',		-- вода
	'weed_pooch',	-- Кутия с козчета
	'weed'			-- Канабис Рудералис
	]]--
  }
